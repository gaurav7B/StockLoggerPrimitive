...
{
    public class BeltHoldService : BackgroundService
    {
        private readonly HttpClient _httpClient;
        private readonly List<(string ticker, string exchange, string name, long id, string symboltoken)> _stocks;
        private readonly BeltHoldAnalyzer _analyzer;

        public BeltHoldService(HttpClient httpClient)
        {
            _httpClient = httpClient;

            _analyzer = new BeltHoldAnalyzer();
