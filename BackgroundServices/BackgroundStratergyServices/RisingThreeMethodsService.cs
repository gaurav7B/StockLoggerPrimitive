...
{
    public class RisingThreeMethodsService : BackgroundService
    {
        private readonly HttpClient _httpClient;
        private readonly List<(string ticker, string exchange, string name, long id, string symboltoken)> _stocks;
        private readonly RisingThreeMethodsAnalyzer _analyzer;

        public RisingThreeMethodsService(HttpClient httpClient)
        {
            _httpClient = httpClient;

            _analyzer = new RisingThreeMethodsAnalyzer();
