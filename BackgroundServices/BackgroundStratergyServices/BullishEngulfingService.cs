...
{
    public class BullishEngulfingService : BackgroundService
    {
        private readonly HttpClient _httpClient;
        private readonly List<(string ticker, string exchange, string name, long id)> _stocks;
        private readonly BullishEngulfingAnalyzer _analyzer;

        public BullishEngulfingService(HttpClient httpClient)
        {
            _httpClient = httpClient;

            _analyzer = new BullishEngulfingAnalyzer();
