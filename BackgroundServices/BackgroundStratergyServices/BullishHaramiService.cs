...
{
    public class BullishHaramiService : BackgroundService
    {
        private readonly HttpClient _httpClient;
        private readonly List<(string ticker, string exchange, string name, long id)> _stocks;
        private readonly BullishHaramiAnalyzer _analyzer;

        public BullishHaramiService(HttpClient httpClient)
        {
            _httpClient = httpClient;

            _analyzer = new BullishHaramiAnalyzer();
