...
{
    public class AbandonedBabyService : BackgroundService
    {
        private readonly HttpClient _httpClient;
        private readonly List<(string ticker, string exchange, string name, long id, string symboltoken)> _stocks;
        private readonly AbandonedBabyAnalyzer _analyzer;

        public AbandonedBabyService(HttpClient httpClient)
        {
            _httpClient = httpClient;

            _analyzer = new AbandonedBabyAnalyzer();
