        ...
        public async Task<string> GetAuthorizationTokenAsync()
        {
            ...
            try
            {
                ...
                if (loginResponseJson.status == true)
                {
                    ...
                    return authorizationToken;  // Return the JWT token
                }
                else
                {
                    return loginResponseJson.message; // Return failed login message
                }
            }
            catch (Exception e)
            {
                return e.Message;  // Return error message if exception occurs
            }
